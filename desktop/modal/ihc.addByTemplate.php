	...
	<form class="form-horizontal" onsubmit="return false;">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<div class="col-md-5">
					<input type="text" class="EqLogicTemplateAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement IHC}}"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-5 control-label" >
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					<select class="EqLogicTemplateAttr form-control" data-l1key="template">
						...
						<?php
						foreach (ihc::devicesParameters() as $id => $template) {		

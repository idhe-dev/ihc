<?php
	...
	$plugin = plugin::byId('ihc');
	sendVarToJS('eqType', $plugin->getId());
	sendVarToJS('AllDpt',Cmdt::All_DPT());
			...
			<div class="eqLogicThumbnailContainer">
				<?php
					foreach ($eqLogics as $eqLogic) {
						...
						$file='plugins/ihc/core/config/devices/'.$eqLogic->getConfiguration('typeTemplate').'.png';
						if(file_exists($file))					
					...
					<?php
						foreach ($eqLogics as $eqLogic) {
							...
							if(file_exists($file))
								...
								echo '<td><img src="plugins/ihc/plugin_info/ihc_icon.png" height="45" /></td>';
					...
					<fieldset>
						<div class="form-group">
							...
							<div class="col-sm-3">
								...
								<input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement IHC}}"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label" >
...
<?php 
include_file('desktop', 'ihc', 'js', 'ihc');
include_file('desktop', 'Template', 'js', 'ihc');
